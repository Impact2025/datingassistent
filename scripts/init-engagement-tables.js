/**
 * Initialize Engagement System Tables
 */

require('dotenv').config({ path: '.env.local' });
const { sql } = require('@vercel/postgres');

async function initEngagementTables() {
  try {
    console.log('🚀 Starting engagement system table initialization...\n');
    ...
    console.log('✅ Engagement system tables initialized successfully!\n');
