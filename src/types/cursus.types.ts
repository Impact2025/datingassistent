...
/** Canonical order of cursus_type tiers, lowest to highest. */
export const CURSUS_TYPE_ORDER = ['gratis', 'starter', 'groeier', 'expert', 'vip'] as const;
export type CursusType = typeof CURSUS_TYPE_ORDER[number];
