          ...
          return (
            <motion.button
              ...
              className={cn(
                ...
                'text-sm text-gray-700 hover:text-pink-700',
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-medium text-gray-900 group-hover:text-pink-700 transition-colors">
                    {action.title}
                  </div>
                ...
                <ArrowRight className="w-4 h-4 text-gray-300 group-hover:text-pink-500 group-hover:translate-x-1 transition-all flex-shrink-0 mt-1" />
              </motion.button>
            );
          })}
        </div>
        ...
        return (
          <motion.button
            ...
            className={cn(
              ...
              'bg-white hover:bg-pink-50 border border-gray-200 hover:border-pink-300',
              'transition-all duration-200 text-left'
            )}
          >
