...
import { Settings, User, Heart, MapPin } from "lucide-react";
...
export function SettingsTab() {
  ...
  const form = useForm<ProfileFormValues>({
    ...
    defaultValues: {
      ...
      seekingAgeMin: userProfile?.seekingAgeMin || 18,
      seekingAgeMax: userProfile?.seekingAgeMax || 99,
      seekingType: userProfile?.seekingType || '',
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Pas hier je basisgegevens aan voor betere matching en coaching.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                ...
                <div className="space-y-6 py-4">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-lg font-semibold">Wat zoek je?</h3>
                    </div>
