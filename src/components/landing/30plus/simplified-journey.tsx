...
const journeySteps = [
  {
    ...
    icon: Heart,
    activities: [
      'Emotionele ready scan - wat zoek je écht?',
      'Dating patroon analyse',
      'Helder krijgen wat jij wil',
    ],
  ...
  },
  {
    ...
    icon: User,
    activities: [
      'Authentiek profiel dat aantrekt wat je wil',
      'De juiste apps voor jouw doel',
      'Slimme filters voor kwaliteitsmatches',
    ],
...
export function SimplifiedJourney30Plus() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg" style={{ color: colors.mediumGray }}>
            Geen eindeloos swipen - gewoon een duidelijk pad naar wat jij wil
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg leading-relaxed mb-4" style={{ color: colors.charcoal }}>
            ...
            Er is geen tijdsdruk. Sommige 30-plussers doorlopen dit in 2 weken, anderen nemen 2 maanden. Beide zijn prima.
          </p>
          <p className="text-base" style={{ color: colors.mediumGray }}>
            Je hebt al genoeg drukte in je leven - dit moet juist duidelijkheid geven.
          </p>
        </motion.div>
      </div>
    </section>
...
export default SimplifiedJourney30Plus;
