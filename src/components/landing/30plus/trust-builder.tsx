...
const trustBadges = [
  ...
  },
  {
    ...
    description: 'Of je nu serieus zoekt of gewoon wil ontdekken',
    color: colors.dustyRose,
  },
  {
    icon: Shield,
    title: 'Groeiende community',
    description: 'Duizenden 30-plussers die serieus op zoek zijn',
    color: colors.sageGreen,
  },
];

export function TrustBuilder30Plus() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-lg leading-relaxed" style={{ color: colors.charcoal }}>
            We begrijpen dat kwetsbaar zijn in je 30s moeilijk is. Daarom werken we met{' '}
...
export default TrustBuilder30Plus;
