...
// import { ProgramCards } from '@/components/landing/program-cards'; // Tijdelijk uit - wacht op database setup
...
export function LandingPageContent({ hero }: LandingPageContentProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* TIJDELIJK: Oude pricing totdat database is geconfigureerd */}
