/**
 * Pattern Quiz Components
 *
 * Export all components for the Dating Pattern Quiz.
 */
...
export { PatternResult } from './pattern-result';
export { PatternResultWithOTO } from './pattern-result-with-oto';
