    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          <Card className="p-6 border-0 bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow">
        ...
        <Card className="p-8 border-0 bg-white shadow-lg">
          <div className="space-y-6">
            <div className="space-y-2">
              <h3 className="text-xl font-semibold text-gray-900">Hoe het werkt</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-gray-900 text-white flex items-center justify-center text-sm font-semibold flex-shrink-0 mt-0.5">
                  1
                </div>
                <div>
                  <div className="font-medium text-gray-900">Foto Strategie</div>
                  <div className="text-sm text-gray-600">Upload, analyseer, optimaliseer (15 min)</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-gray-900">Bio & Profiel Tekst</div>
                  <div className="text-sm text-gray-600">AI schrijft je perfecte bio (20 min)</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-gray-900">Prompts & Details</div>
                  <div className="text-sm text-gray-600">Laatste finetuning (10 min)</div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 space-y-3">
              <Button
                onClick={onStart}
                className="w-full h-12 bg-gray-900 hover:bg-gray-800 text-white font-medium rounded-lg transition-colors group"
              >
                Start Assessment
