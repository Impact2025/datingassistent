    ...
    <div className="min-h-screen p-4 md:p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-6">
          ...
          {/* Progress Bar */}
          <Card className="p-6 border-0 shadow-sm dark:bg-gray-800">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <div className="text-sm text-gray-600 dark:text-gray-400">Totale Voortgang</div>
          ...
          {/* Impact Badge */}
          {overallProgress < 100 && (
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-gray-900 dark:text-white">Verwachte Impact</div>
              ...
              <Card
                ...
                className={`border-2 transition-all ${
                  status.isCompleted
                    ...
                    : 'border-gray-900 dark:border-gray-100 shadow-lg dark:bg-gray-800'
                }`}
              >
                  ...
                  <div className="flex items-start gap-4 md:gap-6">
                    ...
                    <div className="flex-1 min-w-0 space-y-4">
                      <div>
                        ...
                        <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">Geschatte tijd: {step.duration}</div>
                      </div>
                          ...
                          {step.tasks.map((task, idx) => (
                            <li key={idx} className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                              <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 ${
                                status.isCompleted ? 'bg-green-100 dark:bg-green-900/30' : 'bg-gray-100 dark:bg-gray-700'
                              }`}>
                                {status.isCompleted ? (
                      ...
                      {status.isLocked ? (
                        ...
                        <Button
                          onClick={() => onStartStep(step.id)}
                          className="bg-gray-900 hover:bg-gray-800 dark:bg-gray-100 dark:hover:bg-gray-200 text-white dark:text-gray-900 group"
                        >
                          Start {step.title}
        ...
        {/* Completion CTA */}
        {overallProgress === 100 && (
          <Card className="p-8 border-0 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 shadow-lg text-center">
            <div className="space-y-4">
