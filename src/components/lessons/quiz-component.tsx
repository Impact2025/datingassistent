      ...
      >
        <Card className={`border-2 ${passed ? 'border-green-500' : 'border-yellow-500'}`}>
          <CardContent className="p-8 text-center space-y-6">
            ...
            >
              {passed ? (
                <div className="inline-flex items-center justify-center w-24 h-24 bg-coral-500 hover:bg-coral-600 rounded-full shadow-2xl">
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2">
          <motion.div
            className="h-2 rounded-full bg-coral-500 hover:bg-coral-600"
            initial={{ width: 0 }}
          ...
          <Card>
            <CardHeader>
              <div className="flex items-start gap-3">
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-coral-500 hover:bg-coral-600 text-white font-bold flex-shrink-0">
