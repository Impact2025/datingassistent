        ...
        <Card className="bg-gradient-to-r from-purple-50 to-coral-50 border-purple-200">
          <CardContent className="pt-6">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 bg-coral-500 hover:bg-coral-600 rounded-full flex items-center justify-center flex-shrink-0">
          ...
          <Card key={pilaar.id}>
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-coral-500 hover:bg-coral-600 rounded-full flex items-center justify-center text-white text-sm font-bold">
                  {index + 1}
                </div>
                <div>
