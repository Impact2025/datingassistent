...
async function migratePatternQuiz() {
  ...
  try {
    ...
    `;
    logger.log('Created marketing index');
    ...
    `;
    logger.log('Created conversion index');
    ...
    logger.log('Pattern Quiz migration completed successfully!');
  } catch (error) {
