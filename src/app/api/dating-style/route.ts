      ...
      try {
        ...
        await sql`
          INSERT INTO user_scan_history (
            ...
            ${userId}, 'dating-style', ${assessmentId}, NOW(), ${totalTimeSeconds},
            ${scores.primaryStyle},
        ...
        await sql`
          INSERT INTO user_scan_progress (
            user_id, scans_completed, dating_style_completed,
