...
export async function POST() {
  try {
    logger.log('🚀 Starting comprehensive database migration...');

    // 1. Add activity tracking columns to user_profiles
    logger.log('📊 Adding activity tracking columns...');
    await sql`
    ...
    logger.log('👨‍🏫 Creating coaching_profiles table...');
    await sql`
    ...
    logger.log('🧠 Creating personality_scans table...');
    await sql`
    ...
    logger.log('📈 Creating activity_log table...');
    await sql`
    ...
    logger.log('🎯 Creating goals table...');
    await sql`
