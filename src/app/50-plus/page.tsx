...
import { HeroMature50Plus } from '@/components/landing/50plus/hero-mature';
import { TrustBuilder50Plus } from '@/components/landing/50plus/trust-builder';
import { SuccessStories50Plus } from '@/components/landing/50plus/success-stories-50plus';
import { SimplifiedJourney50Plus } from '@/components/landing/50plus/simplified-journey';
...
function ValidationSection() {
  const problems = [
    {
      icon: HelpCircle,
      title: 'Ben ik te oud voor dating apps?',
      desc: 'Op jouw leeftijd lijkt iedereen al een partner te hebben',
      color: colors.warmCoral
    },
    {
      icon: Smartphone,
      title: 'Is dit niet voor jongeren?',
      desc: 'Alle dating apps lijken gemaakt voor dertigers, niet voor jou',
      color: colors.dustyRose
    },
    {
      icon: Heart,
      title: 'Wat zoek ik eigenlijk?',
      desc: 'Na een leven opgebouwd, weet je niet meer of je een partner wilt of gezelschap',
...
// ============================================================================
// TOOLS SECTION - "Waarom 50-plussers succesvol zijn"
// ============================================================================
  ...
  return (
    <section className="py-20 px-4" style={{ backgroundColor: colors.cream }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: colors.deepPurple }}>
            Waarom 50-plussers succesvol zijn
          </h2>
  ...
  const faqs = [
    {
      ...
      answer: 'Absoluut niet. 35% van onze leden is 50-plussers. Veel mensen in jouw levensfase vinden juist nu de meest betekenisvolle relaties omdat ze precies weten wat ze willen. Zelfkennis is je grootste troef.',
    },
    {
      id: 'tech',
    ...
    },
    {
      ...
      answer: 'Privacy staat bij ons voorop, vooral voor 50-plussers met carrière en kinderen. We leren je: welke foto\'s veilig zijn, hoe je werkgever-proof profiel maakt, welke apps privacy-vriendelijk zijn, en hoe je persoonlijke info beschermt.',
    },
    {
      id: 'readiness',
    ...
    {
      id: 'pool',
      question: 'Zijn er wel andere 50-plussers op dating apps?',
      answer: 'Ja! Op apps als Lexa, EliteDating, en zelfs Tinder zijn enorm veel 50-plussers actief. We helpen je de juiste apps kiezen voor jouw situatie en doelen. De dating pool is groter dan je denkt.',
    },
  ];
    ...
    <section className="py-20 px-4 bg-white">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg" style={{ color: colors.mediumGray }}>
            Alle antwoorden die 50-plussers willen weten
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-3" style={{ color: colors.deepPurple }}>
              Dating advies voor 50-plussers
            </h2>
          </div>
...
export default function FiftyPlusPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: colors.cream }}>
      ...
      <ValidationSection />
      <ToolsSection40Plus />
      <SuccessStories50Plus />
      <SimplifiedJourney50Plus />
      <div id="pricing">
