        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
              ...
              <Link href="#tools">
                <Button variant="outline" className="border-2 border-gray-300 text-gray-700 hover:border-pink-500 hover:text-pink-500 px-8 py-3 rounded-full text-lg">
                  Bekijk tools
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            ...
            <div className="text-center space-y-4 p-6 rounded-xl bg-white border border-gray-200 hover:border-pink-200 hover:shadow-md transition-all">
              ...
              <div>
                <h3 className="text-lg font-bold mb-2 text-gray-900">Vaardigheden Assessment</h3>
                <p className="text-sm text-gray-600 leading-relaxed">
            ...
            <div className="text-center space-y-4 p-6 rounded-xl bg-white border border-gray-200 hover:border-pink-200 hover:shadow-md transition-all">
              ...
              <div>
                <h3 className="text-lg font-bold mb-2 text-gray-900">Online Cursus</h3>
                <p className="text-sm text-gray-600 leading-relaxed">
