        ...
        >
          <Card className="border-2 border-gray-200 shadow-xl bg-white">
            <CardContent className="p-8 text-center space-y-6">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gray-100 rounded-full mx-auto">
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        ...
        >
          <Card className="border-2 border-gray-200 shadow-xl bg-white">
            <CardContent className="p-8 text-center space-y-6">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-orange-50 rounded-full mx-auto border-2 border-orange-200">
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        ...
        >
          <Card className="border-2 border-gray-200 shadow-xl bg-white">
            <CardContent className="p-8 text-center space-y-6">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-red-50 rounded-full mx-auto border-2 border-red-200">
        ...
        <Card className="border-2 border-gray-200 shadow-2xl bg-white">
          <CardContent className="p-8 text-center space-y-6">
            ...
            <motion.div
              ...
              className="inline-flex items-center justify-center w-24 h-24 bg-green-50 rounded-full shadow-lg mx-auto border-2 border-green-200"
            >
            ...
            <motion.div
              ...
              className="bg-gray-50 rounded-xl p-6 border border-gray-200 text-left"
            >
...
function PaymentLoadingFallback() {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="border-2 border-gray-200 shadow-xl max-w-md w-full bg-white">
        <CardContent className="p-8 text-center space-y-6">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gray-100 rounded-full mx-auto">
            <Loader2 className="w-10 h-10 text-gray-700 animate-spin" />
          </div>
