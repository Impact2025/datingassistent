                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className={`font-medium ${
                      isStepCompleted ? 'text-green-900 dark:text-green-300 line-through' : 'text-gray-900 dark:text-white'
                    }`}>
                      {stepText}
                    </p>
                    {stepExplanation && (
                      <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{stepExplanation}</p>
                    )}
                  </div>
