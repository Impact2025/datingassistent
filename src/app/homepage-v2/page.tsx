...
/**
 * PALET 2: "Emotionele Luxe"
 *
 * Primaire kleuren:
 * - Royal Purple: #6B4D8A (merkidentiteit, luxe uitstraling)
 * - Rose Gold: #B76E79 (premium touch, exclusiviteit)
 * - Porcelain: #FBF7F4 (elegante basis)
 *
 * Accent kleuren:
 * - Terracotta: #E07A5F (CTA's, actie)
 * - Soft Lavender: #D4C5E2 (emotionele content)
 * - Charcoal: #3D405B (sterke contrasten)
 *
 * Typografie:
 * - Hoofdtekst: #3D405B
 * - Secundaire tekst: #81689D
 */
...
const colors = {
  ...
  charcoal: '#3D405B',
  textPrimary: '#3D405B',
  textSecondary: '#81689D',
};

// Custom Video Player with new colors
function IrisVideoPlayerV2() {
  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto">
      ...
      >
        {/* Decorative gradient border - Royal Purple to Rose Gold */}
        <div
          className="absolute inset-0 rounded-3xl p-[3px] -z-10"
          style={{ background: `linear-gradient(135deg, ${colors.royalPurple}, ${colors.roseGold})` }}
        />
          ...
          {!isLoaded && (
            ...
            >
              <div className="flex flex-col items-center gap-3">
                ...
                />
                <p style={{ color: colors.softLavender }} className="text-sm">Video laden...</p>
              </div>
            </motion.div>
          )}
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    style={{ background: `linear-gradient(135deg, ${colors.terracotta}, ${colors.roseGold})` }}
                  >
          ...
          <AnimatePresence>
            {videoEnded && (
              <motion.div
                ...
                style={{ background: `linear-gradient(to top, ${colors.porcelain}, ${colors.porcelain}F2, ${colors.porcelain}CC)` }}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
...
// Hero Section with Palet 2
function HeroSectionV2() {
  return (
    <section
      className="relative py-12 sm:py-16 lg:py-20 px-4 overflow-hidden"
      style={{ background: `linear-gradient(to bottom, ${colors.porcelain}, white)` }}
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="text-center lg:text-left order-2 lg:order-1 space-y-8">
            ...
            >
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black leading-[0.95] mb-8" style={{ color: colors.charcoal }}>
                <span className="block mb-3">Daten is</span>
                <span className="block mb-3">geen geluk.</span>
                <span
                  className="block"
                  style={{
                    background: `linear-gradient(135deg, ${colors.royalPurple}, ${colors.roseGold})`,
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12">
            <div className="flex items-center gap-2" style={{ color: colors.textSecondary }}>
              <Tv className="w-5 h-5" style={{ color: colors.roseGold }} />
...
// Program Cards with Palet 2
function ProgramCardsV2() {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-start">
        {/* Plan 1: Kickstart */}
        <Card className="relative h-full flex flex-col transition-all hover:shadow-lg bg-white" style={{ borderColor: colors.softLavender, borderWidth: '2px' }}>
          <CardContent className="p-8 space-y-6 flex flex-col flex-grow">
            <div className="text-center space-y-3">
              <h3 className="text-3xl font-bold" style={{ color: colors.charcoal }}>Kickstart</h3>
              <p className="text-sm font-medium" style={{ color: colors.textSecondary }}>
                Snel resultaat in 21 dagen
              </p>
            </div>

            <div className="text-center py-4 border-y" style={{ borderColor: colors.softLavender }}>
              <Badge className="text-white px-3 py-1 text-xs font-bold mb-2" style={{ backgroundColor: '#10B981' }}>
                EARLYBIRD t/m 25 januari
              </Badge>
              <div className="flex items-baseline justify-center gap-3 mb-2">
                <span className="text-2xl line-through" style={{ color: colors.textSecondary }}>€97</span>
                <span className="text-5xl font-bold" style={{ color: colors.charcoal }}>€47</span>
              </div>
            </div>
            ...
            <Button
              ...
              variant="outline"
              className="w-full"
              style={{ borderColor: colors.royalPurple, color: colors.royalPurple }}
            >
              Meer informatie
            </Button>
          </CardContent>
        ...
        <Card
          className="relative h-full flex flex-col transition-all hover:shadow-2xl bg-white md:scale-105 shadow-xl"
          style={{ borderColor: colors.roseGold, borderWidth: '4px' }}
        >
          <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
            <Badge className="text-white px-4 py-2 text-sm font-bold shadow-lg" style={{ backgroundColor: colors.roseGold }}>
              ONZE AANRADER
            </Badge>
          </div>
          ...
          <CardContent className="p-8 space-y-6 flex flex-col flex-grow pt-12">
            <div className="text-center space-y-3">
              <h3 className="text-3xl font-bold" style={{ color: colors.charcoal }}>Transformatie</h3>
              <p className="text-sm font-medium" style={{ color: colors.textSecondary }}>
            ...
            <div className="text-center py-4 border-y" style={{ borderColor: colors.softLavender }}>
              ...
              <div className="flex items-baseline justify-center gap-3 mb-2">
                ...
                <span className="text-5xl font-bold" style={{ color: colors.roseGold }}>€147</span>
              </div>
            </div>
            ...
            <div className="space-y-3 flex-grow">
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-sm" style={{ color: colors.textPrimary }}>
                  <Sparkles className="w-5 h-5 mt-0.5 flex-shrink-0" style={{ color: colors.roseGold }} />
        ...
        <Card
          ...
          style={{
            ...
            borderWidth: '2px',
            background: `linear-gradient(to bottom, ${colors.softLavender}40, white)`
          }}
        >
          <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 z-10">
            <Badge className="text-white px-3 py-1 text-xs font-bold shadow-md" style={{ backgroundColor: colors.royalPurple }}>
          ...
          <CardContent className="p-8 space-y-6 flex flex-col flex-grow pt-10">
            <div className="text-center space-y-3">
              <h3 className="text-3xl font-bold" style={{ color: colors.charcoal }}>VIP Reis</h3>
              <p className="text-sm font-medium" style={{ color: colors.textSecondary }}>
            ...
            <div className="text-center py-4 border-y" style={{ borderColor: colors.softLavender }}>
              ...
              <div className="flex items-baseline justify-center gap-3 mb-2">
                ...
                <span className="text-5xl font-bold" style={{ color: colors.royalPurple }}>€797</span>
              </div>
            </div>
            ...
            <div className="space-y-3 flex-grow">
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-sm" style={{ color: colors.textPrimary }}>
                  <Sparkles className="w-5 h-5 mt-0.5 flex-shrink-0" style={{ color: colors.royalPurple }} />
            ...
            <Button
              ...
              style={{ backgroundColor: colors.royalPurple }}
            >
              Start VIP Traject
            </Button>

            <div className="flex items-center justify-center gap-2 pt-2">
              <AlertCircle className="w-4 h-4" style={{ color: colors.royalPurple }} />
              <p className="text-xs font-medium" style={{ color: colors.royalPurple }}>
...
// Main Homepage V2 with Palet 2
export default function HomePageV2() {
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: colors.porcelain }}>
      {/* Simple Header for Preview */}
      <header className="sticky top-0 z-50 border-b bg-white/95 backdrop-blur" style={{ borderColor: colors.softLavender }}>
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <Link href="/homepage-v2" className="text-xl font-bold" style={{ color: colors.royalPurple }}>
            DatingAssistent
          </Link>
          <div className="flex items-center gap-4">
            <span className="text-xs px-3 py-1 rounded-full font-medium" style={{ backgroundColor: colors.softLavender, color: colors.royalPurple }}>
              PALET 2: Emotionele Luxe
            </span>
            <Link href="/">
              <Button variant="outline" size="sm" style={{ borderColor: colors.royalPurple, color: colors.royalPurple }}>
                Bekijk Origineel
              </Button>
            </Link>
          </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold" style={{ color: colors.charcoal }}>Herken je dit?</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {/* Pijn Blok 1 */}
            <div
              className="rounded-2xl p-8 border-2 hover:shadow-xl transition-all space-y-4 bg-white"
              style={{ borderColor: colors.softLavender }}
            >
              <div
              ...
              <h3 className="text-xl font-bold text-center" style={{ color: colors.charcoal }}>De Match-Droogte</h3>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-center" style={{ color: colors.charcoal }}>De Gespreks-Dood</h3>
              <p className="text-center leading-relaxed" style={{ color: colors.textPrimary }}>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-center" style={{ color: colors.charcoal }}>De &apos;Situationship&apos;</h3>
              <p className="text-center leading-relaxed" style={{ color: colors.textPrimary }}>
          ...
          <div className="text-center">
            <p className="text-xl md:text-2xl font-semibold max-w-3xl mx-auto" style={{ color: colors.charcoal }}>
      ...
      {/* Tools Section */}
      <section id="tools" className="py-20 px-4" style={{ backgroundColor: colors.porcelain }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold" style={{ color: colors.charcoal }}>Jouw 24/7 Wingman Team</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: User, title: 'Profiel Coach', subtitle: 'Nooit meer raden wat werkt', desc: 'AI analyseert foto\'s, bio en selectie. Krijg 7-12 concrete verbeteringen → gemiddeld 3x meer matches binnen 48 uur', color: colors.roseGold },
              { icon: MessageCircle, title: '24/7 Chat Coach', subtitle: 'Weet altijd wat je moet zeggen', desc: 'Match krijgen? Check. Gesprek doodlopen? Never again. Real-time suggesties gebaseerd op context', color: colors.royalPurple },
              { icon: Sparkles, title: 'Opener Lab', subtitle: 'Stop met "Hey, hoe gaat ie?"', desc: 'Originele openingszinnen op basis van hun profiel. 64% respons rate vs 12% met standaard openers', color: colors.terracotta },
              { icon: TrendingUp, title: 'Match Analyse', subtitle: 'Begrijp wie past bij jou', desc: 'AI vergelijkt profielen en voorspelt compatibiliteit. Focus op matches met potentie, bespaar tijd', color: colors.roseGold },
              { icon: Play, title: 'AI Foto Check', subtitle: 'Professionele feedback in seconden', desc: 'Upload foto → AI geeft score + verbeterpunten. Welke foto\'s werken? Welke weg? Data-driven keuzes', color: colors.royalPurple },
              { icon: Calendar, title: 'Date Planner', subtitle: 'Van "koffie?" naar onvergetelijk', desc: 'AI bedenkt creatieve date-ideeën op basis van jullie interesses. Inclusief gesprekstarters', color: colors.terracotta },
              { icon: CheckCircle, title: 'Voortgang Tracker', subtitle: 'Zie je groei week na week', desc: 'Track matches, gesprekken, dates. Zie wat werkt en leer van je successen', color: colors.roseGold },
              { icon: Shield, title: 'Veiligheid Check', subtitle: 'Date veilig, date slim', desc: 'AI herkent rode vlaggen en catfish signalen. Dating tips voor veilige eerste dates', color: colors.royalPurple },
            ].map((tool, i) => (
              <div
                key={i}
              ...
              >
                ...
                <div className="text-center">
                  <h3 className="text-lg font-bold mb-2" style={{ color: colors.charcoal }}>{tool.title}</h3>
      ...
      {/* Journey Section */}
      <section className="py-24 px-4" style={{ background: `linear-gradient(to br, ${colors.porcelain}, white)` }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold" style={{ color: colors.charcoal }}>Van intake tot zelfverzekerde date: Jouw reis</h2>
            <p className="text-lg max-w-2xl mx-auto" style={{ color: colors.textPrimary }}>
              ...
              <div key={i} className="relative">
                ...
                >
                  ...
                  <div className="space-y-3">
                    <h3 className="text-2xl font-bold" style={{ color: colors.charcoal }}>{step.title}</h3>
                    <div className="space-y-2 text-sm" style={{ color: colors.textPrimary }}>
                      {step.items.map((item, j) => (
                        <p key={j}>✓ {item}</p>
                      ))}
                    </div>
                    <div className="pt-2 border-t" style={{ borderColor: colors.softLavender }}>
          ...
          <div
            ...
            style={{
              background: `linear-gradient(to r, ${colors.softLavender}50, ${colors.roseGold}20)`,
      ...
      <section id="programmas" className="py-32 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 space-y-6">
            <h2 className="text-4xl md:text-6xl font-bold" style={{ color: colors.charcoal }}>
      ...
      <section className="py-24 px-4" style={{ background: `linear-gradient(to br, ${colors.porcelain}, white)` }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold" style={{ color: colors.charcoal }}>Resultaten van mensen zoals jij</h2>
            <p className="text-lg max-w-2xl mx-auto" style={{ color: colors.textPrimary }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div className="pt-4 border-t" style={{ borderColor: colors.softLavender }}>
                  <p className="font-semibold" style={{ color: colors.charcoal }}>{review.name}</p>
      ...
      {/* Final CTA Section */}
      <section className="py-24 px-4" style={{ background: `linear-gradient(to br, ${colors.softLavender}30, white)` }}>
        <div className="max-w-2xl mx-auto text-center space-y-8">
          <Card className="border-2 shadow-xl bg-white" style={{ borderColor: colors.roseGold }}>
            <CardContent className="p-8 text-center space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                <div className="text-center p-3 rounded-lg" style={{ backgroundColor: `${colors.roseGold}20` }}>
                  <Heart className="w-5 h-5 mx-auto mb-1" style={{ color: colors.roseGold }} />
                  <p className="text-xs" style={{ color: colors.textSecondary }}>Gratis starten</p>
                </div>
                <div className="text-center p-3 rounded-lg" style={{ backgroundColor: `${colors.royalPurple}20` }}>
                  <Sparkles className="w-5 h-5 mx-auto mb-1" style={{ color: colors.royalPurple }} />
                  <p className="text-xs" style={{ color: colors.textSecondary }}>Direct toegang</p>
                </div>
                <div className="text-center p-3 rounded-lg" style={{ backgroundColor: `${colors.terracotta}20` }}>
                  <TrendingUp className="w-5 h-5 mx-auto mb-1" style={{ color: colors.terracotta }} />
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Card className="border-2 transition-all cursor-pointer hover:shadow-lg" style={{ borderColor: colors.roseGold, background: `linear-gradient(to r, ${colors.softLavender}30, ${colors.roseGold}20)` }}>
              <Link href="/quiz">
                <CardContent className="p-6 text-center relative">
                  ...
                  <div className="w-12 h-12 mx-auto mb-3 rounded-full flex items-center justify-center" style={{ backgroundColor: `${colors.roseGold}30` }}>
                    <Sparkles className="w-6 h-6" style={{ color: colors.roseGold }} />
                  </div>
                  <h3 className="font-semibold text-lg mb-2" style={{ color: colors.roseGold }}>
                    Doe de Quiz
                  </h3>
                  <p className="text-sm mb-2" style={{ color: colors.textPrimary }}>
                    Ontdek je dating stijl
                  </p>
                  <p className="text-xs italic mb-4" style={{ color: colors.roseGold }}>
                  ...
                  <Button
                    ...
                    style={{ background: `linear-gradient(to r, ${colors.terracotta}, ${colors.roseGold})` }}
                  >
                    Gratis Starten
            ...
            <Card className="border-2 hover:shadow-lg transition-all cursor-pointer bg-white" style={{ borderColor: colors.softLavender }}>
              <Link href="/register">
                <CardContent className="p-6 text-center">
                  <div className="w-12 h-12 mx-auto mb-3 rounded-full flex items-center justify-center" style={{ backgroundColor: `${colors.royalPurple}20` }}>
                    <Users className="w-6 h-6" style={{ color: colors.royalPurple }} />
                  </div>
                  <h3 className="font-semibold mb-1" style={{ color: colors.charcoal }}>
                    Direct Beginnen
                  </h3>
                  <p className="text-sm mb-3" style={{ color: colors.textSecondary }}>
                    Maak gratis een account
                  </p>
                  <Button variant="outline" className="w-full" style={{ borderColor: colors.royalPurple, color: colors.royalPurple }}>
                    Registreren
                    <ArrowRight className="w-4 h-4 ml-2" />
                  </Button>
                </CardContent>
      ...
      {/* Simple Footer */}
      <footer className="py-8 px-4 border-t bg-white" style={{ borderColor: colors.softLavender }}>
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-sm" style={{ color: colors.textSecondary }}>
            © 2024 DatingAssistent - Dit is een preview van Palet 2 "Emotionele Luxe"
          </p>
          <div className="mt-4 flex justify-center gap-8">
            <Link href="/" className="text-sm hover:underline" style={{ color: colors.royalPurple }}>
