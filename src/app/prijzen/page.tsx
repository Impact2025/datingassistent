...
const programs = [
  ...
  },
  {
    ...
    features: [
      { text: 'Complete Videocursus (6 Modules)', included: true, highlight: true },
      { text: '1. Het Fundament & Intentie', included: true, indent: true },
      { text: '2. Profiel Psychologie 2.0', included: true, indent: true },
      { text: '3. Slim Matchen & Filteren', included: true, indent: true },
      { text: '4. Het Gesprek (Chat Meesterschap)', included: true, indent: true },
      { text: '5. De Eerste Date Strategie', included: true, indent: true },
      { text: '6. Mindset & Patronen doorbreken', included: true, indent: true },
